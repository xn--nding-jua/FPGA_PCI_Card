...
Type
  ...
  private
    ...
    function IOCTL_IOPMD_GET_SET_LIOPM(Addr: DWORD; var B: byte; cmd: integer): DWORD;
  ...
  public
    ...
    function IOCTL_IOPMD_SET_LIOPM(Addr: DWORD; B: byte): DWORD;  // set a byte (8 ports-worth) in LIOPM
    function IOCTL_IOPMD_GET_LIOPMB(Addr: DWORD; var B: byte): DWORD;  // get a byte from LIOPM (diagnostic)
    function IOCTL_IOPMD_GET_LIOPMA(var A: TIOPM): DWORD;  // get entire LIOPM array (diagnostic)

    function LIOPM_Set_Ports(BeginPort: DWORD; EndPort: DWORD; Enable: Boolean): DWORD;
...
//-------------------------------------------
function TGWIOPM_Driver.IOCTL_IOPMD_GET_SET_LIOPM(Addr: DWORD; var B: byte; cmd: integer): DWORD;
//-------------------------------------------
Var
  dwStatus: DWORD;
  temp: LongBool;
...
//-------------------------------------------
function TGWIOPM_Driver.IOCTL_IOPMD_SET_LIOPM(Addr: DWORD; B: byte):  DWORD;
//-------------------------------------------
Var
  RetVal: DWORD;
Begin
...
//-------------------------------------------
function TGWIOPM_Driver.IOCTL_IOPMD_GET_LIOPMB(Addr: DWORD; var B: byte):  DWORD;
//-------------------------------------------
Var
  RetVal: DWORD;
Begin
...
//-------------------------------------------
function TGWIOPM_Driver.LIOPM_Set_Ports(BeginPort: DWORD; EndPort: DWORD; Enable: Boolean): DWORD;
//-------------------------------------------
Var
  PortNum: DWORD;
  IOPM_Ix, IOPM_BitNum, Last_IOPM_Ix: DWORD;
